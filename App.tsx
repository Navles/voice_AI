...
//   // Load voices on mount and find Indian English voice
//   useEffect(() => {
//     const loadVoices = () => {
//       const voices = window.speechSynthesis.getVoices();
//       if (voices.length > 0) {
...
//         // Find Indian English voice (prioritize Google voices)
...
//         if (indianVoice) {
//           indianEnglishVoiceRef.current = indianVoice;
//           console.log(`Found Indian English voice: ${indianVoice.name} (${indianVoice.lang})`);
//         } else {
//           console.warn('No Indian English voice found, will use default English voice');
//           // Fallback to any English voice
//           const englishVoice = voices.find(voice => voice.lang.startsWith('en'));
//           indianEnglishVoiceRef.current = englishVoice || null;
//         }
//       }
//     };
...
//       if (indianEnglishVoiceRef.current) {
//         utterance.voice = indianEnglishVoiceRef.current;
//         console.log(`Using Indian English voice: ${indianEnglishVoiceRef.current.name}`);
//       } else {
//         console.warn('Indian English voice not set, using default');
//       }
...
//       window.speechSynthesis.speak(utterance);
//       console.log("Speech started with Indian English voice");
//     } catch (e) {
//       console.error("TTS Error:", e);
//       setAppError(`Text-to-speech error: ${(e as Error).message}`);
//       setIsSpeakingText(false);
